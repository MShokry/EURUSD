...
#Reading Data
data = pd.read_csv('DAT_ASCII_EURUSD_M1_201805.csv',sep=';')
data1 = pd.read_csv('DAT_ASCII_EURUSD_M1_201806.csv',sep=';')
#data.iloc[:,1].values.shape[0]+data1.iloc[:,1].values.shape[0]
dataset = np.hstack((data.iloc[:,1].values,data1.iloc[:,1].values))
#dataset.shape
